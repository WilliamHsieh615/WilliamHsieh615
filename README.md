...
|---------|------------------|
| [TodoList](https://github.com/WilliamHsieh615/todolist) | Vue 3 + Spring Boot 全端 Todo App（JWT 認證、CRUD） |
| [Fruit & Essence](https://github.com/WilliamHsieh615/fruit-and-essence) | 模擬果汁官網，全端購物網站 |
| [Sweetaste](https://github.com/WilliamHsieh615/sweetaste) | 現代風甜點購物網站，使用 Jakarta EE |
| [Member Management System](https://github.com/WilliamHsieh615/member-management-system) | Java Servlet + JSP 會員資料管理 |
...
- **國立陽明交通大學**：光子(矽光子&量子)與 AI 應用專業人才養成班、半導體 AI 與 ChatGPT 跨領域班、半導體 AI 與 ChatGPT 應用班、資安攻防與 AI 應用實戰班  
- **六角學院**：前端課程、軟體工程師體驗營  
